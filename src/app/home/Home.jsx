...
export const Home = () => {
  return <div className="flex justify-around items-center min-h-screen">
    ...
    <div className="flex flex-col absolute right-12">
      <button type="button" className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-full text-sm px-2 py-2 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mb-2">
